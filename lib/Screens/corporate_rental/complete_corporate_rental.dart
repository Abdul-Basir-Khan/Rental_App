...
class CompleteCorporateRental extends StatefulWidget {
  const CompleteCorporateRental({Key? key}) : super(key: key);

  @override
  State<CompleteCorporateRental> createState() => _CompleteCorporateRentalState();
}

class _CompleteCorporateRentalState extends State<CompleteCorporateRental> {
                ...
                Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text("Complete Corporate Customer Rental",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16),),
                        Spacer(),
                      ],
                    )
                ),
