...
class BackDatedCarporateScreen extends StatefulWidget {
  const BackDatedCarporateScreen({Key? key}) : super(key: key);

  @override
  State<BackDatedCarporateScreen> createState() => _BackDatedCarporateScreenState();
}

class _BackDatedCarporateScreenState extends State<BackDatedCarporateScreen> {
  @override
                ...
                Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text("Add Backdated Corporate Rental",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16),),
                        Spacer(),
                      ],
                    )
                ),
